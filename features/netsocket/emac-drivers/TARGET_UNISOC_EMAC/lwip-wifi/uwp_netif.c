...
void *packet_rx_queue = NULL;
 
static void uwp_netif_link_up(int netif)
{
...
static void uwp_netif_link_down(int netif)
 {
	 uwp_wifi_msg_t msg = malloc(sizeof(struct UWP_MSG_STRUCT));
	 msg->type = 1;
	 msg->arg1 = 0;
 ...
 void uwp_netif_cb_register(struct wifi_device * dev){
    dev->connect_cb = uwp_netif_link_up;
    dev->disconnect_cb = uwp_netif_link_down;
 }

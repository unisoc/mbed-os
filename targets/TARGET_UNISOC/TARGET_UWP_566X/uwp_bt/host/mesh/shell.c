...
NUTTX_UNUSED pthread_t s_pid;
NUTTX_UNUSED uki_list_t *s_shell_list;
...
static int NUTTX_UNUSED cmd_input_num(int argc, char *argv[])
{
	int err;
...
static int NUTTX_UNUSED cmd_input_str(int argc, char *argv[])
{
	int err;
...
static int NUTTX_UNUSED cmd_static_oob(int argc, char *argv[])
{
	if (argc < 2) {
...
static int NUTTX_UNUSED cmd_uuid(int argc, char *argv[])
{
	u8_t uuid[16];
	size_t len;
...
static int NUTTX_UNUSED cmd_reset(int argc, char *argv[])
{
	bt_mesh_reset();
...
static int NUTTX_UNUSED cmd_lpn(int argc, char *argv[])
{
	static bool enabled;
	int err;
...
static int NUTTX_UNUSED cmd_init(int argc, char *argv[])
{
	int err;
...
#if defined(CONFIG_BT_MESH_GATT_PROXY)
static int NUTTX_UNUSED cmd_ident(int argc, char *argv[])
{
	int err;
...
static int NUTTX_UNUSED cmd_get_comp(int argc, char *argv[])
{
#if 0
...
static int NUTTX_UNUSED cmd_dst(int argc, char *argv[])
{
	if (argc < 2) {
...
static int NUTTX_UNUSED cmd_netidx(int argc, char *argv[])
{
	if (argc < 2) {
...
static int NUTTX_UNUSED cmd_appidx(int argc, char *argv[])
{
	if (argc < 2) {
...
static int NUTTX_UNUSED cmd_net_send(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_iv_update(int argc, char *argv[])
{
#if 0
...
static int NUTTX_UNUSED cmd_iv_update_test(int argc, char *argv[])
{
#if 0
	bool enable;
...
static int NUTTX_UNUSED cmd_rpl_clear(int argc, char *argv[])
{
	bt_mesh_rpl_clear();
	return 0;
}

static int NUTTX_UNUSED cmd_beacon(int argc, char *argv[])
{
	u8_t status;
	int err;
...
static int NUTTX_UNUSED cmd_ttl(int argc, char *argv[])
{
	u8_t ttl;
	int err;
...
static int NUTTX_UNUSED cmd_friend(int argc, char *argv[])
{
	u8_t frnd;
	int err;
...
static int NUTTX_UNUSED cmd_gatt_proxy(int argc, char *argv[])
{
	u8_t proxy;
	int err;
...
static int NUTTX_UNUSED cmd_relay(int argc, char *argv[])
{
	u8_t relay, transmit;
	int err;
...
static int NUTTX_UNUSED cmd_net_key_add(int argc, char *argv[])
{
	u8_t key_val[16];
	u16_t key_net_idx;
	u8_t status;
...
static int NUTTX_UNUSED cmd_app_key_add(int argc, char *argv[])
{
	u8_t key_val[16];
...
static int NUTTX_UNUSED cmd_mod_app_bind(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_mod_sub_add(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_mod_sub_del(int argc, char *argv[])
{
	u16_t elem_addr, sub_addr, mod_id, cid;
	u8_t status;
	int err;
...
static int NUTTX_UNUSED cmd_mod_sub_add_va(int argc, char *argv[])
{
	u16_t elem_addr, sub_addr, mod_id, cid;
	u8_t label[16];
	u8_t status;
...
static int NUTTX_UNUSED cmd_mod_sub_del_va(int argc, char *argv[])
{
	u16_t elem_addr, sub_addr, mod_id, cid;
	u8_t label[16];
	u8_t status;
...
static int NUTTX_UNUSED cmd_mod_pub(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_hb_sub(int argc, char *argv[])
{
	if (argc > 1) {
		if (argc < 4) {
			return -EINVAL;
...
static int NUTTX_UNUSED cmd_hb_pub(int argc, char *argv[])
{
	if (argc > 1) {
		if (argc < 7) {
			return -EINVAL;
...
static int NUTTX_UNUSED cmd_pb(bt_mesh_prov_bearer_t bearer, int argc, char *argv[])
{
	int err;
...
static int NUTTX_UNUSED cmd_pb_adv(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_pb_gatt(int argc, char *argv[])
{
	return cmd_pb(BT_MESH_PROV_GATT, argc, argv);
}
#endif /* CONFIG_BT_MESH_PB_GATT */

static int NUTTX_UNUSED cmd_provision(int argc, char *argv[])
{
	u16_t net_idx, addr;
	u32_t iv_index;
	int err;
...
int NUTTX_UNUSED cmd_timeout(int argc, char *argv[])
{
	s32_t timeout;
...
static int NUTTX_UNUSED cmd_fault_get(int argc, char *argv[])
{
	u8_t faults[32];
	size_t fault_count;
	u8_t test_id;
...
static int NUTTX_UNUSED cmd_fault_clear(int argc, char *argv[])
{
	u8_t faults[32];
	size_t fault_count;
	u8_t test_id;
...
static int NUTTX_UNUSED cmd_fault_clear_unack(int argc, char *argv[])
{
	u16_t cid;
	int err;
...
static int NUTTX_UNUSED cmd_fault_test(int argc, char *argv[])
{
	u8_t faults[32];
	size_t fault_count;
	u8_t test_id;
...
static int NUTTX_UNUSED cmd_fault_test_unack(int argc, char *argv[])
{
	u16_t cid;
	u8_t test_id;
	int err;
...
static int NUTTX_UNUSED cmd_period_get(int argc, char *argv[])
{
	u8_t divisor;
	int err;
...
static int NUTTX_UNUSED cmd_period_set(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_period_set_unack(int argc, char *argv[])
{
	u8_t divisor;
	int err;
...
static int NUTTX_UNUSED cmd_attention_get(int argc, char *argv[])
{
	u8_t attention;
	int err;
...
static int NUTTX_UNUSED cmd_attention_set(int argc, char *argv[])
{
...
static int NUTTX_UNUSED cmd_attention_set_unack(int argc, char *argv[])
{
	u8_t attention;
	int err;
...
static int NUTTX_UNUSED cmd_add_fault(int argc, char *argv[])
{
	u8_t fault_id;
	u8_t i;
...
static int NUTTX_UNUSED cmd_del_fault(int argc, char *argv[])
{
	u8_t fault_id;
	u8_t i;
...
static NUTTX_UNUSED void * mesh_shell_thread(void *arg)
{
    shell_cmd_data *usr = 0;
    uki_list_t *list = (uki_list_t *)arg;
    int i = 0;
    int argc = 0;
    char *argv[5] = {0};
    while(1)
    {
        usr = (shell_cmd_data *)uki_list_pop(list);
        if(!usr)
        {
            continue;
        }
        ...
        for (i = 0; i < sizeof(mesh_commands)/sizeof(mesh_commands[0]); ++i)
        {
            if(!strcmp(argv[0], mesh_commands[i].name))
            {
                (*mesh_commands[i].cb)(argc, argv);
            }
        }
        uki_free(usr);
    }
...
static NUTTX_UNUSED void mesh_send_cmd(int argc, char *argv[])
{
    shell_cmd_data *data = 0;
    int i = 0;


    data = uki_malloc(sizeof(*data));

    for (i = 1; i < argc && i < sizeof(data->argv)/sizeof(data->argv[0]) ; ++i)
    {
    ...
    data->argc = argc - 1;
    uki_list_insert_end(s_shell_list, data);
...
void mesh_shell_init(void)
{
    if(!s_shell_list)
    {
        s_shell_list = uki_list_create(1);
        pthread_create(&s_pid, 0, mesh_shell_thread, s_shell_list);
        pthread_setname_np(s_pid, "mesh_shell_thread");
    }

}

int mesh_shell_test(int argc, char *argv[])
{
#if 1
    mesh_send_cmd(argc, argv);
#else
    int i = 0;
    ...
    for (i = 0; i < sizeof(mesh_commands)/sizeof(mesh_commands[0]); ++i)
    {
        if(!strcmp(argv[0], mesh_commands[i].name))
        {
            (*mesh_commands[i].cb)(argc - 1, &argv[1]);
        }
    }
#endif
    return 0;

...
#define CONFIG_BT_MESH_FRIEND_LPN_COUNT 5
#define CONFIG_BT_MESH_FRIEND_QUEUE_SIZE    (16)
#define CONFIG_BT_MESH_FRIEND_RECV_WIN  50
#define CONFIG_BT_MESH_FRIEND_SEG_RX    5
#define CONFIG_BT_MESH_FRIEND_SUB_LIST_SIZE 5
#define CONFIG_BT_MESH_IVU_DIVIDER  1
#define CONFIG_BT_MESH_LABEL_COUNT  3
#define CONFIG_BT_MESH_LPN_GROUPS   32
#define CONFIG_BT_MESH_LPN_INIT_POLL_TIMEOUT    1
#define CONFIG_BT_MESH_LPN_MIN_QUEUE_SIZE   7
#define CONFIG_BT_MESH_LPN_POLL_TIMEOUT 300
#define CONFIG_BT_MESH_LPN_RECV_DELAY   120
#define CONFIG_BT_MESH_LPN_RECV_WIN_FACTOR  3
#define CONFIG_BT_MESH_LPN_RETRY_TIMEOUT    5
#define CONFIG_BT_MESH_LPN_RSSI_FACTOR  3
#define CONFIG_BT_MESH_LPN_SCAN_LATENCY 30
#define CONFIG_BT_MESH_MODEL_GROUP_COUNT    2
#define CONFIG_BT_MESH_MODEL_KEY_COUNT  2
#define CONFIG_BT_MESH_MSG_CACHE_SIZE   2
#define CONFIG_BT_MESH_PROXY_FILTER_SIZE    10
#define CONFIG_BT_MESH_RPL_STORE_TIMEOUT    600
#define CONFIG_BT_MESH_RX_SDU_MAX   36
#define CONFIG_BT_MESH_RX_SEG_MSG_COUNT 2
#define CONFIG_BT_MESH_SEQ_STORE_RATE   2
#define CONFIG_BT_MESH_STORE_TIMEOUT    5
...
#define CONFIG_BT_MESH_FRIEND_QUEUE_SIZE    16
#define CONFIG_BT_MESH_FRIEND_RECV_WIN  1

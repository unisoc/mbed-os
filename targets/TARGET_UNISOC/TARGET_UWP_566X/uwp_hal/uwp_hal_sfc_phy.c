...
static inline void SFCDRV_SoftReq(void)
{
	reg_sfc->soft_req.mBits.soft_req = BIT(0);
}

static inline void SFCDRV_CMDBufClr(void)
{
...
static inline void SFCDRV_TypeBufClr(void)
{
	reg_sfc->tbuf_clr.mBits.tbuf_clr = BIT(0);
}

static inline void SFCDRV_IntClr(void)
{
...
static inline void SFCDRV_SetCMDBuf(CMD_BUF_INDEX_E index, u32_t value)
{
	switch (index) {
	case CMD_BUF_0:
...
static inline u32_t SFCDRV_GetCMDBuf(CMD_BUF_INDEX_E index)
{
	u32_t value = 0;
...
static inline void SFCDRV_SetTypeInfBuf(CMD_BUF_INDEX_E index, BIT_MODE_E bitmode,
...
static inline u32_t SFCDRV_GetInitAddr(void)
{
	u32_t start_addr = 0;
